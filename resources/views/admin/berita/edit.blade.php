    ...
    @auth
        <div class="content-wrapper">
            <div class="container-fluid" style="padding-top: 0.5cm">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 p-5 shadow-lg rounded">
                            <h3 class="mx-auto">Edit Berita</h3>
                            <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea type="text" autocomplete="off" class="form-control textarea @error('isi') is-invalid @enderror"
                                                name="isi" value="{{ old('isi', $berita->isi) }}" placeholder="Tulis Isi berita" id="isi">{{ $berita->isi }}</textarea>
                                        </div>
