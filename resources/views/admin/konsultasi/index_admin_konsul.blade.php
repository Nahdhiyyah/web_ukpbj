                        ...
                        <table id="example" class="table" style="width:100%;">
                            ...
                            <tbody class="table">
                                ...
                                @foreach ($admin_konsul as $item)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td><img src="{{ asset('/storage/users-avatar/' . $item->avatar) }}" class="circle"
                                                style="width: 50px; height:50px; border-radius: 50%; object-fit: cover">{{ $item->name }}
                                        </td>
                                        <td>{{ $item->subjek }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('destroy.konsul.admin', $item->id) }}" method="POST" id="delete">
                                                <a href="{{ route('show.balas.admin', $item->id) }}" class="btn"
                                                    type="button">
                                                ...
                                                <a href="{{ route('edit.status', $item->id) }}" class="btn">
