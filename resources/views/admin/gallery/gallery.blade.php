                    ...
                    <div class="col-md-12">
                        <div class="card p-2 shadow-md" style="border: none">
                            <div class="card-body table-responsive p-3">
                                <a href="{{ route('gallery.create') }}" class="btn btn-md btn-success mb-3">Buat Gallery</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        ...
                                                        <a href="{{ route('gallery.show', $item->id) }}" class="btn">
                                                        ...
                                                        <a href="{{ route('gallery.edit', $item->id) }}" class="btn">
                                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                                style="fill: #ffd60a"
