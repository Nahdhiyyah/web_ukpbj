    ...
    <div class="container pt-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; ">
                <h6 class="section-title bg-white text-center px-3" style="color: #8C0C14;">Materi / Informasi</h6>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="card shadow p-3 text-center" style="border: none">
                    <h3><a href="{{ route('group.materi') }}" style="color: #8C0C14">Materi</a></h3>
                </div>
            </div>
            <div class="col">
                <div class="card shadow p-3 text-center" style="border: none">
                    <h3><a href="{{ route('group.sdp') }}" style="color: #8C0C14">SDP</a></h3>
                </div>
            </div>
        </div>
    </div>
